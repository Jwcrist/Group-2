...
<<>>=
data1 <- getURL('https://raw.githubusercontent.com/Jwcrist/Group-2/
               master/Data/origin_lat_long3.csv', ssl.verifypeer=0L, followlocation=1L)
origin <- read.csv(text=data1)
data2 <- getURL('https://raw.githubusercontent.com/Jwcrist/Group-2/
               master/Data/Drayage_final_coords.csv', ssl.verifypeer=0L, followlocation=1L)
